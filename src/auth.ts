...
if (!process.env.AUTH_URL) process.env.AUTH_URL = "https://karma-3jf.pages.dev/api/auth";
if (!process.env.NEXTAUTH_URL) process.env.NEXTAUTH_URL = "https://karma-3jf.pages.dev/api/auth";
