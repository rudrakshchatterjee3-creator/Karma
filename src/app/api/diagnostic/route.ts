...
export async function GET(req: Request) {
  ...
  const debugInfo = {
    ...
    AUTH_SECRET_SET: pType !== "undefined" && !!process.env?.AUTH_SECRET,
    AUTH_GOOGLE_ID_SET: pType !== "undefined" && !!process.env?.AUTH_GOOGLE_ID,
    AUTH_GOOGLE_SECRET_SET: pType !== "undefined" && !!process.env?.AUTH_GOOGLE_SECRET,
